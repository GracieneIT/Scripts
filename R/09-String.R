...
tolower("Histrograma e Elementos de Dados")
toupper("Histrograma e Elementos de Dados")
...
#Dividindo uma string em caracteres após o caracter de espaço
...
#Localiza primeira e última posição em que um caracter aparece na string
